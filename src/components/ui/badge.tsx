  ...
  "inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-[11px] font-semibold tracking-wide w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-[oklch(0.65_0.18_155)] text-white [a&]:hover:bg-[oklch(0.60_0.18_155)]",
        warning:
          "border-transparent bg-[oklch(0.78_0.16_75)] text-[oklch(0.20_0.03_75)] [a&]:hover:bg-[oklch(0.73_0.16_75)]",
      },
    },
    defaultVariants: {
      variant: "default",
